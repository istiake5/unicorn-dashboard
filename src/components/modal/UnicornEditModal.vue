                    ...
                    <div class="pb-4">
                        ...
                        <form class="bg-white shadow-md p-4 rounded-md" @submit="editUnicornItem">
                            ...
                            <div class="flex justify-end mt-6">
                                <button
                                    class="border-2 hover:bg-blue-100 focus:ring-4  font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2   focus:outline-none  flex items-center space-x-3"
                                    @click="closeModal">Cancel</button>
                                <button
                                    class="text-white bg-[#4E46B4] hover:bg-[#4E46B4] focus:ring-4 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-[#4E46B4] dark:hover:bg-[#4E46B4] focus:outline-none dark:focus:ring-[#4E46B4] flex items-center space-x-3">Update</button>
                            </div>
                        </form>
                    </div>
                </div>
